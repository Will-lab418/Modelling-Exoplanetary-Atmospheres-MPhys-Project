...
atm_file = 'atm/atmo_wasp39b_pt.txt' # TP and Kzz (optional) file
sflux_file = 'atm/stellar_flux/sflux-wasp39-frances.txt' # This is the flux density at the stellar surface
...
out_name =  'wasp39b_atmo_pt_no_photochem.vul' # output file name
...
use_photo = False
# astronomy input
r_star = 0.939 # stellar radius in solar radius
Rp = 1.28*7.1492E9 # Planetary radius (cm) (for computing gravity)
orbit_radius = 0.048 # planet-star distance in A.U.
...
P_b = 4e8  # pressure at the bottom (dyne/cm^2)
...
gs = 423.         # surface gravity (cm/s^2)  (HD189:2140  HD209:936)
